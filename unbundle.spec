...
Version  : 0.1.4
Release  : 17
URL      : https://github.com/clearlinux/unbundle/releases/download/v0.1.4/unbundle-0.1.4.tar.gz
Source0  : https://github.com/clearlinux/unbundle/releases/download/v0.1.4/unbundle-0.1.4.tar.gz
Summary  : UNKNOWN
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566001803
