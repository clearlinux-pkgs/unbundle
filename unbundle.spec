...
Version  : 0.1.5
Release  : 18
URL      : https://github.com/clearlinux/unbundle/releases/download/v0.1.5/unbundle-0.1.5.tar.gz
Source0  : https://github.com/clearlinux/unbundle/releases/download/v0.1.5/unbundle-0.1.5.tar.gz
Summary  : UNKNOWN
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568937471
